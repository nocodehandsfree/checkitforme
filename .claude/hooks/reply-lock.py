...
STYLE = (
    ...
    "Numbers stay as digits. ALWAYS say the real name of a thing: ElevenLabs is "
    "ElevenLabs, never 'the voice company'. A real name is never wrong, and hiding "
    "one behind a vague description is the worst mistake you can make (owner 08-08). "
    "Use his lexicon names for the things he named; that lexicon is the minimum, not "
    "a fence. A thing with no real name gets described in a plain sentence, never "
    "nicknamed. No computer speak, no "
