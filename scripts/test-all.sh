...
# THE REPLAY GATE (owner's order, 08-21, item 1). Every recorded check — 427, 428, 430, 431, 432, 433, 434 —
...
run "replay gate: seven real records, four things each" "$ENV $TSX scripts/replay-gate.ts"
