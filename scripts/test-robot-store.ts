...
const WORDS: Record<number, string[]> = {
  ...
  // The third line is the owner's 08-07 fix: naming a day makes Charlie ask what TIME, and this
  // scene had nothing left to say, so the check ended on OUR question.
