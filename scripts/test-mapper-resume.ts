...
const savedRun = (chainId: number, over: Partial<MapperRun> = {}): MapperRun => ({
  ...
  log: [{ n: 6, phase: "optimize", store: "T-Store", outcome: "no gain — kept best", seconds: 58 }],
  startedAt: Date.now() - 60_000, updatedAt: Date.now() - 10_000,
  lockedRecipe: null, pinnedStoreId: undefined, verifyMisses: 0, baselineMisses: 1,
  ...over,
});
