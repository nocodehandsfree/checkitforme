...
const GTM_SEED: { id: string; title: string; detail: string; area: "backend" | "frontend" | "ops"; agent: string; critical: boolean; status: "todo" | "doing" | "done" }[] = [
  ...
  { id: "db-backups", title: "Database backups + tested restore", detail: "Nightly snapshot of both /data SQLite volumes off-box (R2), plus a documented, TESTED restore. No backup tooling exists today.", area: "backend", agent: "devops", critical: true, status: "todo" },
