...
<h2 ${H2}>Recording</h2>
<p>Check AI records the calls it makes, and it says so at the start of each call. How we handle those recordings is in the <a href="/p/privacy" onclick="if(window.openPage){openPage('privacy');return false}">Privacy Policy</a>.</p>
...
<li><b>Your checks.</b> The store, the product, the result, and a written transcript and summary of the call.</li>
...
<h2 ${H2}>The calls are recorded</h2>
<p>When Check AI calls a store, the call is recorded, and the agent says so out loud at the start, because some states require everyone on the line to know. We keep the written transcript and a short summary as your proof of what the store said. We do not keep the audio.</p>
...
<p>We keep your account, your checks, and your transcripts until you ask us to delete them, or until we no longer need them to run the service. Delete your account and we remove your personal data, apart from the little the law requires us to hold.</p>
...
<h2 ${H2}>Grabación</h2>
<p>Check AI graba las llamadas que hace, y lo avisa al empezar cada llamada. Cómo manejamos esas grabaciones está en la <a href="/p/privacy" onclick="if(window.openPage){openPage('privacy');return false}">Política de privacidad</a>.</p>
...
<li><b>Tus verificaciones.</b> La tienda, el producto, el resultado, y una transcripción escrita y un resumen de la llamada.</li>
...
<h2 ${H2}>Las llamadas se graban</h2>
<p>Cuando Check AI llama a una tienda, la llamada se graba, y el agente lo dice en voz alta al empezar, porque algunos estados exigen que todos en la línea lo sepan. Guardamos la transcripción escrita y un breve resumen como tu prueba de lo que dijo la tienda. No guardamos el audio.</p>
...
<p>Guardamos tu cuenta, tus verificaciones y tus transcripciones hasta que pidas borrarlas, o hasta que ya no las necesitemos para el servicio. Borra tu cuenta y eliminamos tus datos personales, salvo lo poco que la ley nos obliga a conservar.</p>
