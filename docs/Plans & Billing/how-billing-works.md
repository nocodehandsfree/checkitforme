...
1. You pick a plan or a bundle and pay through Stripe.
2. The moment payment clears, your account gets its checks.
3. Spending burns plan checks first, then pay as you go.
4. Renewals refill your plan checks automatically.
