...
Even clean content reads as noise at **28 different font sizes** and a dozen ad-hoc margins. Lock ~5 sizes (caption 11 / body 13 / label 15 / stat 20 / title 26) and a 4/8/12/16 spacing scale, apply everywhere. This alone makes the same data feel calm. Details and worst offenders in §F.
