...
**Owner-approved 08-07, one addition to section 12.** Charlie went silent when Staff asked him to repeat, which loses the check. Being asked to repeat is now the ONE exception to never saying a question twice, with a guard so a disliked answer can never become an excuse to ask again. The brief's other item (never ask a question already answered) was NOT added: section 9 and section 10 already command it, and a third copy is the stacking that made him disobey before. Nothing in his words mentions being handed Staff's turn on reconnect; he cannot tell that from hearing it live, and naming it would invite him to treat the two differently.
