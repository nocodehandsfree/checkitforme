...
| [Location does not follow you to a new town](site-location-follow-gate.md) | site | owner 08-06, hundreds of miles from home and still shown his home stores. DIAGNOSED, not fixed: both the drive-follow and the slider's re-check return unless the browser reports location already `granted`, and the saved spot is good for 7 days. Proven on the rig that the logic works when the gate opens |
