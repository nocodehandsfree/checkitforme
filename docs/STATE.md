...
git. Last updated: 2026-07-30 (every try back runs the same way; Mapped checks carry the speed gain).
...
- **Driven on the real staging site:** the conversation follows its newest line, the live page and the
  pulling-the-result screen end clear of Safari's bottom bar, "Too far?" cannot flash while off. Alerts next.
...
- We ask once to be put through, stop paying while they hand us over, ask again when somebody new picks up.
  A switch in Calls → App turns it off. Only your phone can test the real words.
