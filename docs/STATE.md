...
- Every engine test is green (111 rig checks; a real browser drove the live page clean). The "No charge" wording on a hold drop is Webbie's one string (your ruling stands: a hold drop is charged). **Run 6 is the next thing.**
