...
## Mapping (07-30/31): every try back walks the menu the same way, the chain page is rebuilt, and a
  re-map hangs up on the second ring so it never troubles Staff. **The rebuild restarts clean: your
  rounds are LAW in the contract**, three chunks, the PM checks each, and you test ONCE at the end.
