# SUPPORT — NEVER-BREAK RULES (exempt from all size caps: ADD, never delete to fit)
...
(none recorded yet — the moment a rule is born, it goes here, never only in a chat or a code comment)
