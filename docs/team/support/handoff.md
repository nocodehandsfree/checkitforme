...
the build, the escalation ladder, and the knowledge loop. Cross-system: the book's words + widget
placement are the site system's; Discord/infra/keys are the data system's (old ops lane).
