...
- ⚠️ **07-30 STAGING DEPLOY b2caee06 STUCK IN RAILWAY'S QUEUE 18+ min** ("Processing deployment...",
  `canRedeploy:false`, plan pro, NOTHING else building in the project). Staging serves 8efd9cce. **The
  first real re-listen check is BLOCKED on it; owner does not want it forced.**
